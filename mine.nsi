...
#For installer icon;
#!define MUI_ICON "TinderBot.ico"
#For uinstaller icon
#!define MUI_UNICON "TinderBot.ico"
#!define MUI_WELCOMEPAGE_TEXT "Welcome to TinderBot Setup"
!define MUI_PAGE_HEADER_TEXT "For any problem,please contact administrator "
...
#For Shortcut run as Administrator put down this code;
!ifndef IPersistFile
...
InstallDir $PROGRAMFILES\bhwb
; Set the text to prompt user to enter a directory
DirText "This will install Our Program on your computer. Choose a directory"
#RequestExecutionLevel admin
...
Section "MainSection" SEC01
   ...
   ; where INSTDIR = C:\Program Files\
   SetOutPath $INSTDIR
   
   ;Create the installation directory
   CreateDirectory $INSTDIR
   
   #For writting uninstall.exe 
   WriteUninstaller "$INSTDIR\uninstall.exe"
   WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\uninstall.exe" \
                 "DisplayName" "BHWBot"
   WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\uninstall.exe" \
	             "DisplayIcon" "$INSTDIR\TinderBot.ico" 
   #WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\uninstall.exe" \
   ...
   File /r "C:\Users\PC3\Desktop\BHWBot\BHW.exe"
...
#For System checking it's 32 or 64 bit;

Function system
${If} ${RunningX64}
    DetailPrint "64-bit Windows"
	#MessageBox MB_OK "Your Operating system is x64"
	Call JreInstrallation_64  
${Else}
    DetailPrint "32-bit Windows"
	#MessageBox MBK "Your Operating system is x32"
	Call JreInstrallation_32  
${EndIf}  
FunctionEnd
...
Section "uninstall"
    ...
    Delete "$SMPROGRAMS\BHW.lnk"
	Delete "$DESKTOP\BHW.lnk"
 
# uninstaller section end
SectionEnd

!define PRODUCT_NAME "JRE"
!define JRE_VERSION_64 "1.8.10_201"
!define JRE_VERSION_32 "1.8.0_25"
!define JRE_URL_64 "https://javadl.oracle.com/webapps/download/AutoDL?BundleId=236885_42970487e3af4f5aa5bca3f542482c60"
!define JRE_URL_32 "https://javadl.oracle.com/webapps/download/AutoDL?BundleId=95501"

Function GetJRE_64
        MessageBox MB_OK " JRE version ${JRE_VERSION_64}, it will now \
                         be downloaded and installed"
 
        StrCpy $2 "$TEMP\Java Runtime Environment.exe"
        nsisdl::download /TIMEOUT=30000 ${JRE_URL_64} $2
...
Function JreInstrallation_64 
 ReadRegStr $2 HKLM "SOFTWARE\JavaSoft\Java Runtime Environment" \
             "CurrentVersion"
  StrCmp $2 ${JRE_VERSION_64} done
...
Function GetJRE_32
        MessageBox MB_OK " JRE version ${JRE_VERSION_32}, it will now \
                         be downloaded and installed"
 
        StrCpy $2 "$TEMP\Java Runtime Environment.exe"
        nsisdl::download /TIMEOUT=30000 ${JRE_URL_32} $2
        Pop $R0 ;Get the return value
                StrCmp $R0 "success" +3
                MessageBox MB_OK "Download failed: $R0"
                Quit
...
Function JreInstrallation_32 
 ReadRegStr $2 HKLM "SOFTWARE\JavaSoft\Java Runtime Environment" \
             "CurrentVersion"
  StrCmp $2 ${JRE_VERSION_32} done
...
Function TinderBot
Exec $INSTDIR\BHW.exe
#RequestExecutionLevel admin
# CreateDirectory $INSTDIR
#Compile time
#!appendfile "$%temp%\compiletimefile.txt" ""
SetOutPath $INSTDIR
File /r "C:\Users\PC3\Desktop\BHWBot\New folder\*"
FileOpen $4 "$INSTDIR\location.properties" w
FileWrite $4 "path=$INSTDIR"
FileClose $4
ShellLink::SetRunAsAdministrator "$INSTDIR\BHW.exe"
ShellLink::SetRunAsAdministrator "$DESKTOP\BHW.exe"
CreateShortcut "$smprograms\my app\TinderBot.lnk" "$INSTDIR\BHW.exe"
CreateShortCut "$DESKTOP\BHW.lnk" "$INSTDIR\BHW.exe"
push "$DESKTOP\BHW.lnk"
...
FunctionEnd
 ...
 #including Library in Logiclib.nsh start
...
!verbose pop
 ...
 #including Library in Logiclib.nsh end.You now get all method that are required;

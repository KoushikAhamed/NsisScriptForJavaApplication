...
SOURCE="$(InputPath)"
PostBuild_Cmds=copy %OUTDIR%\*.dll "C:\Program Files\DevTools\NSIS\xtras\Plugins\"	dumpbin /SECTION:.text %outdir%\*.dll|find /I "size"	dumpbin /SECTION:.data %outdir%\*.dll|find /I "size"
